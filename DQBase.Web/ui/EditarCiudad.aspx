<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarCiudad.aspx.cs" Inherits="DQBase.Web.ui.EditarCiudad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenedorPrincipal" runat="server">
    ...
    <table class="style1">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" CssClass="LabelTitulo" Text="Ciudades"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="style1">
                    <tr>
                        <td class="style3">
                            <asp:Label ID="Label2" runat="server" CssClass="LabelNormal" Text="Region"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlRegiones" runat="server" Width="150px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
